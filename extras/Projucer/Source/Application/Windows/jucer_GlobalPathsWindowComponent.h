...
private:
    ValueWithDefault jucePathValue, juceModulePathValue, userModulePathValue, vst3PathValue, rtasPathValue, aaxPathValue, araPathValue,
    ...
    void updateFilePathPropertyComponents()
    {
        ...
        if (getSelectedOS() == TargetOS::linux)
        {
            ...
            addAndMakeVisible (pathPropertyComponents.add (new FilePathPropertyComponent (Value(), "ARA SDK", true, isThisOS)));
            pathPropertyComponents.getLast()->setEnabled (false);
        }
        else
        {
            ...
            addAndMakeVisible (pathPropertyComponents.add (new FilePathPropertyComponent (araPathValue,  "ARA SDK", true, isThisOS)));
        }
