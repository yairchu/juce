...
public:
    ...
    public:
       ...
       ARA_DISABLE_UNREFERENCED_PARAMETER_WARNING_BEGIN
        ...
        virtual void doUpdateAudioSourceContent (ARAAudioSource* audioSource, const ARA::ARAContentTimeRange* range, ARA::ContentUpdateScopes scopeFlags) {}
...
public:         // to be called by ARADocumentController only
    ...
    void doUpdateAudioSourceContent (const ARA::ARAContentTimeRange* range, ARA::ContentUpdateScopes scopeFlags);
